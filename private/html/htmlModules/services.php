...
function displayServiceModule()
{
    ...
    <div class="service_buttons col-md-12">
        ...
        <div id="it-solution-selection-services-link" class="col-md-2 serviceLink">
            ...
            <img src="/etg/public/assets/images/search-icon.png" alt="magnifying glass" class="servicesIcon" />
        </div>
        ...
        <div id="business-change-management-services-link" class="col-md-2 serviceLink">
            ...
            <img src="/etg/public/assets/images/change-icon.png" alt="business change" class="servicesIcon" />
        </div>
        ...
        <div id="it-transformation-services-link" class="col-md-2 serviceLink">
            ...
            <img src="/etg/public/assets/images/transform-icon.png" alt="it transformation" class="servicesIcon" />
        </div>
        ...
        <div id="technical-delivery-services-link" class="col-md-2 serviceLink">
            ...
            <img src="/etg/public/assets/images/technical-icon.png" alt="technical delivery" class="servicesIcon" />
        </div>
        ...
        <div id="support-services-link" class="col-md-2 serviceLink">
            ...
            <img src="/etg/public/assets/images/support-icon.jpg" alt="support person" class="servicesIcon" />
        </div>
